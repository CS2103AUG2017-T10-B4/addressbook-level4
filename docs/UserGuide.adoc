...
****
* Deletes the tag by specifying `TAGNAME`.
* The TagNAME refers to the tag name that is used in the address book.
* The tag name must be a tag name used.
****

Examples:

* `deletetag friends` 
Deletes the 'friends' tag from every who has that tag.
