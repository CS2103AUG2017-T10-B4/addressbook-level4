...
Add a remark to a specific person from the address book. +
...
* `list` +
`remark 2 r/owe money` +
Adds a "owe money" remark at the end of the contact.
* `find Betsy` +
`remark 1 r/best friend` +
Add a "best friend" remark to the 1st person in the results of the `find` command.
