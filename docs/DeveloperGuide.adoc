...
By keying in the command word `recentlyDel`, the command word will be detected in the `AddressBookParser` class, and it will be brought over to the `RecentlyDeletedCommand` class.
...
.  Should have an easy to follow user guide
.  System should be able to keep all private tagged information confidential.
.  System should open the help page when user enters an invalid entry.
.  System should be easy to maintain in event of malfunction.
