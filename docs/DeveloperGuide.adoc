...
|===
|name |phone |email |address |website |tag
 ...
 * `NoSuchElementException`: Just as `AddCommand`, this happens when `name`, `phone`, `email`, `address` or `website` is missing, and that specific entry will not be added.
